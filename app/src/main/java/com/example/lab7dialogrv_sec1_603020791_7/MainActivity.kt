package com.example.lab7dialogrv_sec1_603020791_7
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View) {
        ...
        mDialogView.btnAdd.setOnClickListener{
            studentList.add( Student( mDialogView.edit_id.text.toString(), mDialogView.edit_name.text.toString(),mDialogView.edit_age.text.toString().toInt()))
    ...
    fun testStudentData(){
        studentList.add(Student("601234567-8","Student1", 20))
